...
export const SearchBooksPage = () => {
  ...
  const [totalAmountBooks, setTotalAmountOfBooks] = useState(0);
  const [totalPages, setTotoalPages] = useState(0);
  const [search, setSearch] = useState("");
  const [searchUrl, setSearchUrl] = useState("");
  const [categorySelect, setCategorySelect] = useState("Book Category");
  ...
  let lastItem = booksPerPage * currentPage <= totalAmountBooks ? booksPerPage
    * currentPage : totalAmountBooks;
